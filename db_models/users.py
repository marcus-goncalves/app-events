...
class User(Base):
    ...
    # id_role = Column(ForeignKey("roles.id"), nullable=False)
    ...
    id_work_shift = Column(Integer, nullable=True)
    id_schedule = Column(Integer, nullable=True)
    id_teams_group = Column(Integer, nullable=True)
